    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                <View style={styles.avatarPlaceholder}><User size={18} color="#fff" /></View>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.galleryGrid}>
                    <Image source={{ uri: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c' }} style={styles.galleryImage} />
                    <Image source={{ uri: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2' }} style={styles.galleryImage} />
                    <View style={styles.morePhotosContainer}>
                        <Image source={{ uri: 'https://images.unsplash.com/photo-1497215842964-222925615a41' }} style={[styles.galleryImage, { width: '100%', marginBottom: 0 }]} />
...
const styles = StyleSheet.create({
    ...
    logoBadge: { position: 'absolute', bottom: -15, left: 15, width: 60, height: 60, backgroundColor: '#b91c1c', borderRadius: 8, justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: '#fff' },
    ...
    galleryImage: { width: '48%', height: 140, borderRadius: 12, marginBottom: 15 },
    morePhotosContainer: { width: '100%', height: 140, borderRadius: 12, overflow: 'hidden' },
    overlayMore: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(185, 28, 28, 0.7)', justifyContent: 'center', alignItems: 'center' },
    overlayText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },

    publishButton: { backgroundColor: '#b91c1c', paddingVertical: 16, borderRadius: 8, alignItems: 'center', marginTop: 30 },
